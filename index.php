...
if ($token == "d2555ef8faa2788ebb5434b6dc9955cd" or $token == "9e78c5c20b172e66f75779d35040796a"){
	if(filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4)) {
		...
		print("<div class='map'><div style='padding: 5px 20px 5px 5px; position: absolute; background: black; top: 4%;'><img src='/images/favicon.ico' style='height: 4vh; display: inline-block;'></img><p style='vertical-align: 13; display: inline-block; font-size: 20px; color: white; position: relative; left: 10px;'>SHO.SYS</p><form action='/index.php' method='GET'><div class='searchbox'><div class='input-wrapper'><label for='search-query' value='Enter search query' class='visually-hidden'></label><input type='hidden' name='auth' value='{$tokenold}'><input type='text' name='ip' placeholder='Enter IP...' id='search-query'></div><button type='submit' aria-label='Submit search querxy' data-balloon-disable='data-balloon-disable' class='button-red'><svg class='svg-inline--fa fa-search fa-w-16 fa-fw' aria-hidden='true' focusable='false' data-prefix='fas' data-icon='search' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512' data-fa-i2svg=''><path fill='currentColor' d='M505 442.7L405.3 343c-4.5-4.5-10.6-7-17-7H372c27.6-35.3 44-79.7 44-128C416 93.1 322.9 0 208 0S0 93.1 0 208s93.1 208 208 208c48.3 0 92.7-16.4 128-44v16.3c0 6.4 2.5 12.5 7 17l99.7 99.7c9.4 9.4 24.6 9.4 33.9 0l28.3-28.3c9.4-9.4 9.4-24.6.1-34zM208 336c-70.7 0-128-57.2-128-128 0-70.7 57.2-128 128-128 70.7 0 128 57.2 128 128 0 70.7-57.2 128-128 128z'></path></svg><!-- <i class='fas fa-search  fa-fw '></i> Font Awesome fontawesome.com --></button></div></form></div><div style='padding: 5px; position: absolute; background: black; top: 17%;'><p style='font-size: 30px; color: white;'>{$ip}</p></div><iframe style='width: 100%; height: 20%; margin-bottom: 5px;' src='https://api.maptiler.com/maps/hybrid/?key=JbVUUx31lOPoXakQzYBc#1.0/" . $loc[0] . "/" . $loc[1] . "'></iframe></dev>");
