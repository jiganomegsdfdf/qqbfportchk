...
if ($token == "9e78c5c20b172e66f75779d35040796a" or $token == "d2555ef8faa2788ebb5434b6dc9955cd"){
	...
	if(filter_var($ip, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4)) {
		...
		print("<div class='map'><div style='padding: 5px; position: absolute; background: black; top: 18%;'><p style='font-size: 30px; color: white;'>{$ip}</p></div><iframe style='width: 100%; height: 20%; margin-bottom: 5px;' src='https://api.maptiler.com/maps/hybrid/?key=JbVUUx31lOPoXakQzYBc#1.0/" . $loc[0] . "/" . $loc[1] . "'></iframe></dev>");
